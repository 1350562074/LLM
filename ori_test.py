...
with open('./final_valid_sft.json','r',encoding='utf-8') as f:
    data = json.load(f)
...
for temp in tqdm(data):
    code_before = temp["conversations"][0]["value"]
    code_after = temp["conversations"][1]["value"]
...
with open('/data/lh/LLM/all_res_llama2_ori.json','w+',encoding='utf-8') as f:
