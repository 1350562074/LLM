...
def train(
    ...
    data_path: str = "./final_train_sft.json",
    test_data_path: str = "./final_test_sft.json",
    do_eval: bool = True,
    output_dir: str = "./checkpoints_XXX",
    ...
    if do_eval:
        ...
        val_data = test_data["train"].shuffle().map(generate_and_tokenize_prompt)
    else:
        train_data = data["train"].shuffle().map(generate_and_tokenize_prompt)
        val_data = None
    ...
    trainer = transformers.Trainer(
        ...
        args=transformers.TrainingArguments(
            ...
            save_strategy="steps",
            eval_steps=20 if do_eval else None,
            save_steps=20,
